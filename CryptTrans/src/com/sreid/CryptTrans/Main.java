 ...
 * Client mode and with or without a GUI No CLI mode implemented yet... but I
 * really want one eventually.
 * 
 * @author sreid
 *
 */
	...
	public static void main(String[] args) {
		...
		do {
			...
			if (result == 0) {
				...
				// help chosen, going to show description of client and server
				// modes, then loop back to the choice.
				MessageDialog help = new MessageDialog(
						shell,
						"CryptTrans Configuration Help",
						null,
